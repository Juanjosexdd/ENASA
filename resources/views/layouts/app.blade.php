        ...
        <div class="relative sm:max-w-sm w-full">
            ...
            <div class="relative w-full rounded-3xl  px-6 py-4 bg-gray-100 shadow-md">
                ...
                <form method="#" action="#" class="mt-10">
                    ...
                    <div>
                        <input type="email" placeholder="  Email" class="mt-1 block w-full border border-blue-500 bg-gray-100 h-11 rounded-md shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0">
                    </div>
        
                    <div class="mt-7">                
                        <input type="password" placeholder="  Contraseña" class="mt-1 block w-full border border-blue-500 bg-gray-100 h-11 rounded-md shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0">                           
                    </div>
